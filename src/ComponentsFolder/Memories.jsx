      ...
      {props.type === "dsp300" ? (
        <>
          <div className="gallery">
            ...
            {see ? <p onClick={handleClick}>See more</p> : null}
            ...
            <button
              ...
              onClick={() => {
                if (props.type === "dsp300") {
                  navigate(props.noLink || "/form"); // ✅ GO TO FORM
                } else {
                  openModal(); // ✅ OPEN MODAL FOR OTHERS
                }
              }}
            >
              Enroll
      ...
      >
        <div className="confirm">
          ...
          <ol>
            ...
            <li>
              {" "}
              Training will hold at least TWICE EVERY WEEK for 4 hours daily.
            </li>
          </ol>
